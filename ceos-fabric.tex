...
{\small
\textit{Note: TENANT\_A and TENANT\_B use different RTs on purpose --- no route}\\
\textit{leaking, so host4 will not reach host1/2/3. That's intended VRF isolation,}\\
\textit{not a bug --- good talking point for the interview.}
}
